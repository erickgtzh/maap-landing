...
function whatsappIcon() {
  return `
    <svg viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
      <path d="M13.6 2.3A7.9 7.9 0 0 0 8 0a7.9 7.9 0 0 0-6.8 11.9L0 16l4.2-1.1A7.9 7.9 0 0 0 8 16a8 8 0 0 0 8-7.9 7.9 7.9 0 0 0-2.4-5.8ZM8 14.6a6.6 6.6 0 0 1-3.4-.9l-.2-.2-2.5.7.7-2.4-.2-.3A6.6 6.6 0 0 1 1.4 8 6.6 6.6 0 1 1 8 14.6Zm3.6-4.9c-.2-.1-1.2-.6-1.3-.6-.2-.1-.3-.1-.5.1l-.6.8c-.1.1-.3.2-.5.1a5.4 5.4 0 0 1-1.6-1 6 6 0 0 1-1.1-1.4c-.1-.2 0-.3.1-.4l.3-.4.2-.3c.1-.1.1-.2 0-.4l-.6-1.4c-.1-.3-.3-.3-.5-.3h-.4c-.1 0-.4.1-.6.3-.2.2-.8.8-.8 1.9s.8 2.2.9 2.3c.1.2 1.6 2.5 4 3.5.6.2 1 .4 1.3.5.6.2 1.1.2 1.5.1.5-.1 1.2-.5 1.4-1 .2-.5.2-.9.1-1 0-.2-.2-.2-.4-.3Z"/>
    </svg>
  `
}
